window.Instagram = {
	...
	tagsByName: function( name, callback ) {
		var endpoint = this.BASE_URL + '/tags/' + name + '/media/recent?scope=basic&access_token=' + this.config.access_token;
		$.ajax({
			type: 'GET',
			url: endpoint,
			dataType: 'jsonp',
...
// https://api.instagram.com/oauth/authorize/?client_id=214b851c9b9449eb8f3162ac981ce678&redirect_uri=http://www.damienvignol.com/photography/&response_type=code&scope=public_content
